      ...
      MaterialApp(     
        ...
        theme: ThemeData(        
          colorScheme: ColorScheme.light(          
            ...
            outline: const Color.fromARGB(255, 205, 205, 205).withOpacity(0.3)
        ...
        darkTheme:ThemeData(
          ...
          colorScheme: ColorScheme.dark(
            primary: const Color(0xFF6ab0f9), // Lighter blue for better contrast on dark
            secondary: const Color(0xFF0a66a9),
            tertiary: const Color.fromARGB(255, 41, 64, 112),
            error: const Color(0xFFCF6679),
            background: const Color(0xFF121212).withOpacity(0.3), // Standard Material dark background
            ...
            surfaceContainerLow: const Color(0xFF212121), // Replaces your F1F1F1
          ...
          textTheme: GoogleFonts.cairoTextTheme(ThemeData.dark().textTheme).copyWith(
            titleLarge: TextStyle(
              fontFamily: GoogleFonts.cairo().fontFamily,
              fontSize: 15.sp.ap(adaptivePercentage: const AdaptivePercentage(tablet: 80, desktop: 60)),
              color: Colors.white,
              fontWeight: FontWeight.bold,
            ),
            titleMedium: TextStyle(
            ...
            bodyLarge: TextStyle(
              ...
              fontSize: 14.sp.ap(adaptivePercentage: const AdaptivePercentage(tablet: 80, desktop: 60)),
            ),   
        ),),
        home: const StartUp(),
